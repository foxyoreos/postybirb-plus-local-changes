...
const builderMap = require('../tl/builder/index.cjs');
const Serializer = require('../tl/serializer/index.cjs');
const Deserializer = require('../tl/deserializer/index.cjs');
const {
  bytesIsEqual,
  getRandomBytes,
  concatBytes,
...
const { createLogger } = require('../utils/common/logger/index.cjs');
